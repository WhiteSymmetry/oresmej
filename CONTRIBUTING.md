...
To report a bug, first make sure there isn't already an open [GitHub Issue](https://github.com/WhiteSymmetry/oresmej/issues)
...
* The oresmej version you are using.
* Detailed steps to reproduce the bug.
* A tag, if appropriate (_e.g._, "bug" or "enhancement").

### Fix Open Issues

Look through the [GitHub Issues](https://github.com/WhiteSymmetry/oresmej/issues) for any
...
Ready to contribute? Here's how to set up oresmej for local development.
...
2. Create your own fork of the oresmej [repository](https://github.com/WhiteSymmetry/oresmej).
...
Please note that the oresmej project is released with a
